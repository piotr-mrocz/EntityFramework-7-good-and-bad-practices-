...
public sealed class GetAllOrdersOldQuery : IRequest<Response<List<OrderDto>>>
{
}

file sealed class GetAllOrdersOldHandler : IRequestHandler<GetAllOrdersOldQuery, Response<List<OrderDto>>>
{
